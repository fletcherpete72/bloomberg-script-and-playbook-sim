# Stub for IAG5 service: get-md5-checksum-eos-upgrade
...
def main():
    parser = argparse.ArgumentParser(description="Fetch the MD5 checksum of an EOS upgrade image from a device")
    ...
    parser.add_argument("--filename", required=True, help="EOS image filename to checksum")
